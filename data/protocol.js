...
module.exports = {
	...
	AdminPacket: {
		...
		SERVER_ERROR:           102, // The server tells the admin an error has occured.
	...
	AdminPacketDescription: {
		...
		117: {
			...
			format: [
				{name: "companyId",      type: "UInt8"},
				{name: "money",          type: "Int64LE"},
				{name: "currentLoan",    type: "Int64LE"},
				{name: "income",         type: "Int64LE"},
				{name: "deliveredCargo", type: "UInt16LE"},
				{name: "value1",         type: "Int64LE"},
				{name: "performance1",   type: "Int16LE"},
				{name: "cargo1",         type: "UInt16LE"},
				{name: "value2",         type: "Int64LE"},
				{name: "performance2",   type: "Int16LE"},
				{name: "cargo2",         type: "UInt16LE"},
			],
		},
		118: {
